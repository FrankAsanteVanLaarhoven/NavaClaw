...
interface GlowCardProps {
  children: ReactNode;
  className?: string;
  glowColor?: 'blue' | 'emerald' | 'green' | 'red' | 'orange';
  size?: 'sm' | 'md' | 'lg';
  width?: string | number;
...
const GlowCard: React.FC<GlowCardProps> = ({ 
  ...
  const getInlineStyles = () => {
    const baseStyles = {
      ...
      '--radius': '14',
      '--border': '3',
      '--backdrop': 'transparent', // Changed from frosted glass to transparent
      '--backup-border': 'rgba(255, 255, 255, 0.1)', // Very subtle border
      '--size': '200',
      '--outer': '1',
